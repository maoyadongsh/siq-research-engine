...
DEFAULT_WIKI_ROOT = Path(os.environ.get("WIKI_ROOT", "/home/maoyd/wiki"))
...
def main() -> None:
    ...
    parser.add_argument("--wiki-root", default=str(DEFAULT_WIKI_ROOT), help="Wiki 根目录，默认读取 WIKI_ROOT，未设置则为 /home/maoyd/wiki")
