...
metadata: {"siq_hermes":{"version":"0.1.0","category":"business","tags":["due-diligence","investment","analysis","finance","legal","risk"]}}
---
...
Due Diligence Analyst is an intelligent SIQ Hermes skill designed for investors, M&A advisors, and corporate development teams. It automates the entire due diligence process, providing multi-dimensional analysis including financial health, legal compliance, business operations, team background, market position, and risk assessment.
...
3. **AI Analysis**: Uses the Hermes agent to analyze information and generate insights
4. **Professional Output**: Returns structured, formatted reports

## Data Sources

**Current Version (MVP)**:
- AI reasoning and analysis using the Hermes agent
...
- **Community**: SIQ Hermes Discord server
