...
**CRITICAL PRINCIPLE 2**: Use the Hermes agent's DOCX and XLSX skills to programmatically create the report.

**REQUIRED TOOLS** (the Hermes agent has built-in skills for these):
...
**DO**: Use the Hermes agent's DOCX and XLSX skills to open files, extract data, and create the DOCX report
...
Use the Hermes agent's file operations to check:
...
**Open and inspect files using the Hermes agent skills:**
...
**Use the Hermes agent's XLSX skill to extract data from Excel files:**
...
Use the Hermes agent's DOCX skill to:
...
Use the Hermes agent's DOCX and XLSX skills to:
...
**Throughout the entire assembly process, use the Hermes agent's DOCX and XLSX skills with actual file operations:**
...
**Do NOT manually copy/paste. Use the Hermes agent's built-in skills to:**
