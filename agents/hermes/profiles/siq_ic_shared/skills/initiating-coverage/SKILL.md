...
3. Execute report assembly workflow using the Hermes agent's built-in skills:
...
**Key Principles**:
- Use the Hermes agent's DOCX and XLSX skills (NOT Python libraries)
...
the Hermes agent: "Starting Task 5: Report Assembly for Tesla
