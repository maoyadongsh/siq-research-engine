...
- 主表项目展开附注必须遵循 `/home/maoyd/siq-research-engine/data/hermes/home/profiles/shared/rules/financial_source_routing_contract.md`：账面价值/账面净值/净额/余额先查三大表，原值/准备/构成/变动再查附注；混合口径问题必须同时召回两类来源。
