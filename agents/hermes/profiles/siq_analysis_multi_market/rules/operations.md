...
```bash
/home/maoyd/siq-research-engine/data/hermes/home/profiles/siq_analysis_multi_market/scripts/maintain_profile.py --archive-sessions-older-than-days 30 --vacuum
```
