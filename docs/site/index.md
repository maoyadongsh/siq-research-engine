...
- :material-book-open: **[产品概览](product/overview.md)**
...
- :material-sitemap: **[整体架构](architecture/overview.md)**
...
- [源仓库 README](https://github.com/maoyadongsh/siq-research-engine)
- [OpenShell + Hermes 集成现状](https://github.com/maoyadongsh/siq-research-engine/blob/master/docs/siq-openshell-hermes-integration-status.md)
- [OpenShell NO-GO 到 GO 路线](https://github.com/maoyadongsh/siq-research-engine/blob/master/docs/runbooks/openshell/no-go-to-go-readiness-matrix.md)
