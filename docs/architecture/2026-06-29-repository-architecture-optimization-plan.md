...
- 剩余大文件仍包括 `index.css`、`DocumentResultWorkbench.tsx`；`PdfSourceWorkbench.tsx` 已完成第一阶段 pane/page preview 拆分，`SearchDownload.tsx` 已完成 model/table/downloaded panel 第一阶段拆分。
