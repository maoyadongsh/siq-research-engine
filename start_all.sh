...
export SIQ_AGENT_MEMORY_ANALYTICS_ENABLED="${SIQ_AGENT_MEMORY_ANALYTICS_ENABLED:-true}"
export SIQ_AGENT_MEMORY_ANALYTICS_SCAN_LIMIT="${SIQ_AGENT_MEMORY_ANALYTICS_SCAN_LIMIT:-10000}"
export SIQ_AGENT_MEMORY_ANALYTICS_MAX_ITEMS="${SIQ_AGENT_MEMORY_ANALYTICS_MAX_ITEMS:-10}"
