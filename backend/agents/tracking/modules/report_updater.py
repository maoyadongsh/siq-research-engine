...
class ReportUpdater:
    ...
    def __init__(self, wiki_base_path: str | None = None):
        self.wiki_base = wiki_base_path or str(tracking_base_path())

    def _tracking_dir(self, stock_code: str, company_name: str) -> str:
        return str(company_tracking_dir(self.wiki_base, stock_code, company_name))
    ...
    def update_report(
        ...
        """
        # 确保目录存在
        company_dir = self._tracking_dir(stock_code, company_name)
