...
EU_ANNUAL_REPORT_CATALOG: tuple[EuAnnualReportCatalogEntry, ...] = (
    ...
    EuAnnualReportCatalogEntry(
        ...
        document_url="https://www.relx.com/~/media/Files/R/RELX-Group/documents/reports/annual-reports/relx-2025-annual-report.pdf",
        landing_url="https://www.relx.com/investors/annual-reports/2025",
        report_end=date(2025, 12, 31),
        published_at=date(2026, 2, 19),
        title="RELX Annual Report 2025",
        aliases=("RELX", "RELX PLC", "REL", "REL.L"),
    ),
    EuAnnualReportCatalogEntry(
        country="GB",
        company_id="GB:DGE",
    ...
    EuAnnualReportCatalogEntry(
        ...
        ticker="BN",
        company_name="Danone",
        document_url="https://www.danone.com/content/dam/corp/global/danonecom/investors/en-all-publications/2026/registrationdocuments/danoneurdaccessible.pdf",
        landing_url="https://www.danone.com/investors/publications-and-events/financial-and-extra-financial-reports.html",
        report_end=date(2025, 12, 31),
        published_at=date(2026, 3, 4),
        title="Danone Universal Registration Document 2025",
        aliases=("Danone", "DANONE", "BN", "BN.PA"),
    ),
    EuAnnualReportCatalogEntry(
        country="FR",
        company_id="FR:BNP",
    ...
    EuAnnualReportCatalogEntry(
        ...
        company_id="DE:DB1",
        ticker="DB1",
        company_name="Deutsche Boerse AG",
        document_url="https://www.deutsche-boerse.com/resource/blob/4932348/d6d302b8d549de98f963142a9e3987d1/data/annual-report-2025_tug_konzern-jahresfinanzbericht_en.pdf",
        landing_url="https://www.deutsche-boerse.com/dbg-en/investor-relations/financial-reports/annual-report-2025",
        report_end=date(2025, 12, 31),
        published_at=date(2026, 2, 11),
        title="Deutsche Boerse Annual Report 2025",
        aliases=("Deutsche Boerse", "Deutsche Boerse AG", "DB1", "DB1.DE"),
    ),
    EuAnnualReportCatalogEntry(
        country="DE",
        company_id="DE:MBG",
    ...
    EuAnnualReportCatalogEntry(
        ...
        company_id="NL:REN",
        ticker="REN",
        company_name="RELX N.V.",
        document_url="https://www.relx.com/~/media/Files/R/RELX-Group/documents/reports/annual-reports/relx-2025-annual-report.pdf",
        landing_url="https://www.relx.com/investors/annual-reports/2025",
        report_end=date(2025, 12, 31),
        published_at=date(2026, 2, 19),
        title="RELX Annual Report 2025",
        aliases=("RELX", "RELX N.V.", "REN", "REN.AS"),
    ),
    EuAnnualReportCatalogEntry(
        country="NL",
        company_id="NL:INGA",
    ...
    EuAnnualReportCatalogEntry(
        ...
        document_url="https://reports.geberit.com/annual-report/2025/_assets/downloads/geberit-ar25-en-entire.pdf",
        landing_url="https://reports.geberit.com/annual-report/2025/services/downloads.html",
        report_end=date(2025, 12, 31),
        published_at=date(2026, 3, 12),
        title="Geberit Annual Report 2025",
        aliases=("Geberit", "Geberit AG", "GEBN", "GEBN.SW"),
    ),
    EuAnnualReportCatalogEntry(
        country="CH",
        company_id="CH:ZURN",
    ...
    EuAnnualReportCatalogEntry(
        ...
        document_url="https://www.givaudan.com/files/giv-2025-gcfr.pdf",
        landing_url="https://integratedreport.givaudan.com/2025/download-centre",
        report_end=date(2025, 12, 31),
        published_at=date(2026, 1, 28),
        title="Givaudan Governance, Compensation and Financial Report 2025",
        aliases=("Givaudan", "Givaudan SA", "GIVN", "GIVN.SW"),
    ),
    EuAnnualReportCatalogEntry(
        country="CH",
        company_id="CH:CFR",
