...
OPERATING_METRIC_RULES: tuple[OperatingMetricRule, ...] = (
    ...
    OperatingMetricRule(
        ...
        "real_estate",
        "ratio_percent",
        ("occupancy rate", "occupancy", "出租率", "租用率", "入住率"),
        ("REIT operational statistics", "portfolio operating table"),
        ("ratio_reasonable", "evidence_required"),
    ),
    OperatingMetricRule(
        "portfolio_valuation",
        "real_estate",
        "money",
        ("valuation", "portfolio valuation", "property valuation", "retail property valuation", "物业估值", "物業估值"),
        ("REIT portfolio valuation table", "valuation section"),
        ("non_negative", "currency_required", "evidence_required"),
    ),
    OperatingMetricRule(
        "net_property_income",
        "real_estate",
        "money",
        ("net property income", "npi", "property income", "物业收入净额", "物業收入淨額"),
        ("REIT financial highlights", "property income table"),
        ("non_negative", "currency_required", "evidence_required"),
    ),
    OperatingMetricRule(
        ...
        "real_estate",
        "money_per_unit",
        ("distribution per unit", "dpu", "每基金单位分派", "每基金單位分派", "每单位分派", "每單位分派"),
        ("REIT distribution table", "financial highlights"),
        ("non_negative", "evidence_required"),
    ),
    OperatingMetricRule(
        "proved_reserves",
        "energy",
