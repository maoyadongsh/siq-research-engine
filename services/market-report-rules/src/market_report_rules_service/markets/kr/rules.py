...
KR_LABEL_RULES: tuple[MetricRule, ...] = (
    ...
    MetricRule("net_profit", StatementType.INCOME_STATEMENT, ("당기순이익", "당기순손익", "계속영업당기순손익", "분기순이익", "연결당기순이익", "profit for the period", "net income"), 10),
    ...
    MetricRule("total_assets", StatementType.BALANCE_SHEET, ("자산총계", "자산 총계", "자산층계", "자산총액", "total assets"), 10),
    ...
    MetricRule("total_liabilities", StatementType.BALANCE_SHEET, ("부채총계", "부채 총계", "부채계", "부채총액", "total liabilities"), 10),
    ...
    MetricRule("total_equity", StatementType.BALANCE_SHEET, ("자본총계", "자본 총계", "자본계", "자본총액", "total equity"), 10),
    ...
    MetricRule("total_liabilities_and_equity", StatementType.BALANCE_SHEET, ("부채와자본총계", "부채및자본총계", "부채와자본층계", "부채및자본층계", "total liabilities and equity")),
    ...
    MetricRule("cash_equivalents_ending", StatementType.CASH_FLOW_STATEMENT, ("기말현금및현금성자산", "기말의 현금및현금성자산", "기말현금", "cash and cash equivalents at end")),
