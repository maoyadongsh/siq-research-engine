...
JP_LABEL_RULES: tuple[MetricRule, ...] = (
    ...
    MetricRule("operating_cash_flow_net", StatementType.CASH_FLOW_STATEMENT, ("営業活動によるキャッシュフロー", "営業活動によるキャッシュ・フロー", "net cash provided by operating activities", "net cash provided by used in operating activities", "net cash provided by (used in) operating activities", "net cash generated by operating activities", "cash generated by operating activities", "cash flows from operating activities"), 10),
    MetricRule("investing_cash_flow_net", StatementType.CASH_FLOW_STATEMENT, ("投資活動によるキャッシュフロー", "投資活動によるキャッシュ・フロー", "net cash used in investing activities", "net cash provided by used in investing activities", "net cash provided by (used in) investing activities", "net cash generated by investing activities", "cash flows from investing activities")),
    MetricRule("financing_cash_flow_net", StatementType.CASH_FLOW_STATEMENT, ("財務活動によるキャッシュフロー", "財務活動によるキャッシュ・フロー", "net cash used in financing activities", "net cash provided by financing activities", "net cash provided by used in financing activities", "net cash provided by (used in) financing activities", "net cash generated by financing activities", "cash flows from financing activities")),
