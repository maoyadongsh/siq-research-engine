...
JP_LABEL_RULES: tuple[MetricRule, ...] = (
    ...
    MetricRule("total_profit", StatementType.INCOME_STATEMENT, ("税引前利益", "経常利益", "profit before tax", "ordinary income")),
    ...
    MetricRule("parent_net_profit", StatementType.INCOME_STATEMENT, ("親会社の所有者に帰属する当期利益", "親会社株主に帰属する当期純利益", "owners of parent")),
    ...
    MetricRule("operating_cash_flow_net", StatementType.CASH_FLOW_STATEMENT, ("営業活動によるキャッシュフロー", "営業活動によるキャッシュ・フロー", "net cash provided by operating activities"), 10),
    MetricRule("investing_cash_flow_net", StatementType.CASH_FLOW_STATEMENT, ("投資活動によるキャッシュフロー", "投資活動によるキャッシュ・フロー", "net cash used in investing activities")),
    MetricRule("financing_cash_flow_net", StatementType.CASH_FLOW_STATEMENT, ("財務活動によるキャッシュフロー", "財務活動によるキャッシュ・フロー", "net cash used in financing activities")),
