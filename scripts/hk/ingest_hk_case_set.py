...
def main() -> None:
    ...
    parser.add_argument("--output-root", type=Path, default=REPO_ROOT / "data" / "wiki" / "hk_reports")
    ...
    parser.add_argument("--report", type=Path, default=REPO_ROOT / "data" / "wiki" / "hk_reports" / "hk_ingest_report.json")
