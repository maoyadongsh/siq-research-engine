...
截至 2026-07-06，SIQ 已从“多服务技术验证”推进到“可售卖样板闭环”阶段。当前最重要的产品样板是 A 股全链路研究闭环：以美的集团（000333）为代表，项目内已有 A 股年报解析产物、LLM Wiki 事实图谱、三表指标、证据链、分析报告、事实核查、跟踪报告、法务意见和 PDF 溯源产物；同时保留港股 HKEX、美股 SEC、欧股 ESEF、日股 EDINET、韩股 DART 和通用文档解析能力。
