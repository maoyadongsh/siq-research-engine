...
from scripts.openshell import siq_analysis_pool_concurrency as pool_concurrency
from scripts.openshell import siq_analysis_pool_registry as pool_registry
from scripts.openshell.siq_analysis_lifecycle import LifecycleError, SystemBackend
from scripts.openshell.siq_analysis_pool_lifecycle import PoolLifecycleError, PoolLifecycleManager
        ...
        with self._maintenance_lock():
            ...
            for local_port in range(pool_registry.FIRST_POOL_PORT, pool_registry.LAST_POOL_PORT + 1):
                ...
                try:
                    ...
                    return
                except PoolLifecycleError as exc:
