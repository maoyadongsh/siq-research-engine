...
export SIQ_REPORT_FINDER_ROOT="${SIQ_REPORT_FINDER_ROOT:-$PROJECT_ROOT/services/report-finder}"
export SIQ_REPORT_DOWNLOADS_ROOT="${SIQ_REPORT_DOWNLOADS_ROOT:-$PROJECT_ROOT/data/report-finder/downloads}"
