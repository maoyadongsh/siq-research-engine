...
const operationEntries: GuideEntry[] = [
  ...
  { to: '/primary-market', icon: Landmark, title: '一级市场', desc: '维护一级市场项目推进、材料中心、投研决策、项目管理和投后记录。' },
  { to: '/deals', icon: BriefcaseBusiness, title: '项目管理', desc: '穿透到单个一级市场项目，查看资料室、证据、工作流、投决和审计细节。' },
