...
def test_merge_jp_quality_candidates_promotes_medium_statement_with_financial_evidence():
    report = {
        "market": "JP",
        "report_kind": "jp_annual_securities_report",
        "table_index": [
        ...
        "key_table_candidates": {
            "Consolidated Statement of Financial Position": [
                {
                    "name": "Consolidated Statement of Financial Position",
                    "status": "found",
                    "table_index": 150,
                    "line": 3539,
        ...
        "core_financial_table_candidates": [
            {"name": "Consolidated Statement of Financial Position", "status": "found", "table_index": 150}
        ],
        "found_financial_tables": ["Consolidated Statement of Financial Position"],
    }
    financial_data = {
        "market": "JP",
        "report_kind": "jp_annual_securities_report",
                ...
                "items": [
                    {
                        ...
                        "evidence": {
                            ...
                            "raw": {
                                "detected_statement_type": "balance_sheet",
                                "table": {"table_index": 150, "line": 3539, "source": "edinet_pdf_statement_table"},
                            },
                        },
                    }
                ],
    ...
    row = merged["key_table_candidates"]["Consolidated Statement of Financial Position"][0]
