...
class QwenTableJudge:
    def __init__(self, api_base=None, model=None, cache_dir=None, timeout=None, prompt_version=None):
        self.api_base = (api_base or os.environ.get("FINANCIAL_LLM_API_BASE") or "").rstrip("/")
        self.model = model or os.environ.get("FINANCIAL_LLM_MODEL", "qwen3.6")
    ...
    def from_env(cls, cache_dir=None):
        ...
        api_base = os.environ.get("FINANCIAL_LLM_API_BASE")
