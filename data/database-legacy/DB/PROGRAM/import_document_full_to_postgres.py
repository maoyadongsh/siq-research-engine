...
WIKISET_DIR = Path("/home/maoyd/wiki/wikiset")
...
DEFAULT_RESULTS_DIR = Path("/home/maoyd/pdf2md_web_backup_20260511_000657测试样本/results")
DEFAULT_WIKI_COMPANIES_DIR = Path("/home/maoyd/wiki/companies")
...
DDL_PATH = BASE_DIR / "DDL" / "001_create_pdf2md_schema.sql"
DML_PATH = BASE_DIR / "DML" / "001_upsert_document_full.sql"
ENRICHED_DML_PATH = BASE_DIR / "DML" / "002_build_financial_items_enriched.sql"
...
def main() -> int:
    ...
    parser.add_argument("--config-py", type=Path, help="Python file that defines PG_CONFIG")
