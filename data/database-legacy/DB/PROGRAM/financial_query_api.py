...
Run:
  uvicorn DB.PROGRAM.financial_query_api:app --host 0.0.0.0 --port 18888
...
try:
    ...
    raise RuntimeError(f"Cannot import PostgreSQL config from {CONFIG_DIR}") from exc
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=int(os.getenv("PORT", "18888")))
