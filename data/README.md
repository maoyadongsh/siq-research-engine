...
| `data/pdf-parser` | `apps/pdf-parser` | 上传 PDF、解析输出、任务库、财务缓存、日志、工作流任务记录 |
| `data/market-report-finder` | `services/market-report-finder` | CN/HK/US 原始报告、HTML/iXBRL/PDF 和下载索引 |
...
| 类型 | 建议 |
| --- | --- |
| 原始 PDF | 保留来源、下载时间、文件 hash 和公司目录 |
